define(['./module', 'jquery'], function (directives, $) {
    'use strict';
    directives.directive('fsmStickyHeader', ['$rootScope', function($rootScope){
        return {
            restrict: 'EA',
            replace: false,
            scope: {
            ...
            link: function(scope, element, attributes, control){
                ...
                function determineVisibility(){
                    ...
                    if(!$.isWindow(scrollableContainer[0])){
    ...
    directives.directive('fsmMenu', ['$location', function ($location) {
        return {
            restrict: 'A',
            scope: {},
    ...
    directives.directive('fsmMenuButton', function () {
        return {
            restrict: 'EA',
            replace: false,
            scope: {},
    ...
    directives.directive('fsmBigData', ['$filter', function ($filter) {
    ...
    directives.directive('fsmSort', [function () {
